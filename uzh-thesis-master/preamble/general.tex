...
\MFUnocap{and}
\usepackage{titlesec}
\usepackage{algorithm}% To support proper pseudocode 
\usepackage[noend]{algpseudocode}% To support proper pseudocode 
\usepackage{sectsty}
\usepackage{appendix}
\usepackage{blkarray}
\usepackage{lscape} 
...
\usepackage{floatrow}
\usepackage{caption}
\captionsetup{format=plain,font=small,labelfont={sc},margin=15pt}
...
\titleformat{\chapter}[display]%
  {\relax}{\vspace*{-1\baselineskip}\makebox[\linewidth][r]{\color{halfgray}\chapterNumber\thechapter}}{10pt}%
  {\raggedright}[\normalsize\vspace*{1.0\baselineskip}\titlerule]%
